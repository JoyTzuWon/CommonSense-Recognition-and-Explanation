...
if __name__ == '__main__':
    ...
    train_dataset = utils.preprocess_task2("./ALL data/train.csv", tokenizer, template, sep_token = "[SEP]")
    print("Train samples:", len(train_dataset))
    valid_dataset = utils.preprocess_task2("./ALL data/dev.csv", tokenizer, template, sep_token = "[SEP]")
    ...
    # save model
    save_model_path = "./save_model/task2_bert-large-uncased_template1"
